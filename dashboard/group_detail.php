        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title">OpenSSL</h4>
                            <?php
                                include $_SERVER['DOCUMENT_ROOT'].'/rapid_auth_admin/backend/config.php';
                                include_once $_SERVER['DOCUMENT_ROOT'].'/rapid_auth_admin/backend/includes.php';
                                ...
                                if (is_admin(get_cookie_information()[2]))
                                {
                                    $gid = $_GET["gid"];
                                    echo '
                                    <form method="post" action="../backend/groups/update_openssl.php?gid=' . $_GET["gid"] . '">
                                    <div class="col-lg-12">
                                    <div class="card-box">

                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">OpenSSL Crypting Key</label>
                                            <input name="openssl_crypting_key" class="form-control" rows="5" value="'. htmlspecialchars(get_openssl_crypting_key_by_gid($gid)).'">
                                        </div>
                                    </div> <!-- end card-box -->
