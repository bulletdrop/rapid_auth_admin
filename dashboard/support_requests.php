...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Rapid Auth - Support Requests</title>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title">Your support requests</h4>
                                ...
                                <tbody>
                                    ...
                                    $tickets = fetch_tickets_by_uid($uid);
                                    ...
                                    foreach ($tickets as $ticket)
                                    {
                                        ...
                                        echo '<td><a href="view_support.php?tid='.$ticket[2].'"><button type="button" class="btn btn-info w-md">View</button></a></td>';
                                        echo '</tr>';
                                    }
